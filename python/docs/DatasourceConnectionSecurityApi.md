# openapi_client.DatasourceConnectionSecurityApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.DatasourceConnectionSecurityApi(api_client)
    connection_uid = 'co_qf2hyt' # str | 
    group_security = openapi_client.GroupSecurity() # GroupSecurity |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.DatasourceConnectionSecurityApi(api_client)
    connection_uid = 'co_qf2hyt' # str | 
    user_security = openapi_client.UserSecurity() # UserSecurity |  (optional)
