...
class ArcgisOpendataHarvester(Harvester):
    ...
    compute_geo_area: Optional[StrictBool] = False
    fetch_data: Optional[StrictBool] = False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "compute_geo_area": obj.get("compute_geo_area") if obj.get("compute_geo_area") is not None else False,
            "fetch_data": obj.get("fetch_data") if obj.get("fetch_data") is not None else False,
