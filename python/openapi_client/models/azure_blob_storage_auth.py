...
class AzureBlobStorageAuth(BaseModel):
    """
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'shared_key': 'AzureBlobStorageSharedKeyAuth'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AzureBlobStorageSharedKeyAuth]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AzureBlobStorageSharedKeyAuth]]:
        """Create an instance of AzureBlobStorageAuth from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'shared_key':
            return import_module("openapi_client.models.azure_blob_storage_shared_key_auth").AzureBlobStorageSharedKeyAuth.from_dict(obj)
