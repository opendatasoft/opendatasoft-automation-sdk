...
class AzureBlobStorageDatasource(Datasource):
    """
    AzureBlobStorageDatasource
    """ # noqa: E501
    url: Optional[StrictStr] = None
    headers: Optional[List[HTTPDatasource1Headers]] = None
    connection: AzureBlobStorageDatasourceAllOfConnection
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connection": AzureBlobStorageDatasourceAllOfConnection.from_dict(obj["connection"]) if obj.get("connection") is not None else None
        })
        return _obj
