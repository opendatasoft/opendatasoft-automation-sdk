...
class Connection(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AmazonS3Connection, AzureBlobStorageConnection, FTPConnection, GoogleDriveConnection, HTTPConnection, SharepointConnection]]:
        ...
        if object_type ==  'amazon_s3':
            return import_module("openapi_client.models.amazon_s3_connection").AmazonS3Connection.from_dict(obj)
        if object_type ==  'azure_blob_storage':
            return import_module("openapi_client.models.azure_blob_storage_connection").AzureBlobStorageConnection.from_dict(obj)
        if object_type ==  'ftp':
            return import_module("openapi_client.models.ftp_connection").FTPConnection.from_dict(obj)
        if object_type ==  'google_drive':
            return import_module("openapi_client.models.google_drive_connection").GoogleDriveConnection.from_dict(obj)
        if object_type ==  'http':
            return import_module("openapi_client.models.http_connection").HTTPConnection.from_dict(obj)
        if object_type ==  'sharepoint':
            return import_module("openapi_client.models.sharepoint_connection").SharepointConnection.from_dict(obj)
