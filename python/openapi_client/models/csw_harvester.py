...
class CSWHarvester(Harvester):
    ...
    keywords_thesaurus: Optional[StrictStr] = ''
    theme_thesaurus: Optional[StrictStr] = ''
    insert_br_in_description: Optional[StrictBool] = False
    constraint_language: Optional[StrictBool] = False
    invert_coordinates: Optional[StrictBool] = False
    themes_mapping: Optional[Dict[str, Dict[str, StrictStr]]] = None
    licenses_mapping: Optional[Dict[str, StrictStr]] = None
    ...
    __properties: ClassVar[List[str]] = ["uid", "type", "name", "status", "version", "restrict_datasets_visibility", "delete_missing_datasets", "forced_metas", "remote_datasets_count", "harvested_datasets_count", "published_datasets_count", "attached_datasets_count", "has_error", "resource_errors_count", "created_at", "updated_at", "updated_by", "last_started_at", "last_success_at", "url", "keywords_thesaurus", "theme_thesaurus", "insert_br_in_description", "constraint_language", "invert_coordinates", "themes_mapping", "licenses_mapping", "metadata_only"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "keywords_thesaurus": obj.get("keywords_thesaurus") if obj.get("keywords_thesaurus") is not None else '',
            "theme_thesaurus": obj.get("theme_thesaurus") if obj.get("theme_thesaurus") is not None else '',
            "insert_br_in_description": obj.get("insert_br_in_description") if obj.get("insert_br_in_description") is not None else False,
            "constraint_language": obj.get("constraint_language") if obj.get("constraint_language") is not None else False,
            "invert_coordinates": obj.get("invert_coordinates") if obj.get("invert_coordinates") is not None else False,
            "themes_mapping": obj.get("themes_mapping"),
            "licenses_mapping": obj.get("licenses_mapping"),
