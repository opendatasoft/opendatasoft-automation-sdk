...
class DatagouvHarvester(Harvester):
    """
    DatagouvHarvester
    """ # noqa: E501
    organization_id: Annotated[str, Field(min_length=1, strict=True)]
    attachment: Optional[StrictBool] = False
    filter_name: Optional[StrictStr] = ''
    filter_value: Optional[StrictStr] = ''
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filter_name": obj.get("filter_name") if obj.get("filter_name") is not None else '',
            "filter_value": obj.get("filter_value") if obj.get("filter_value") is not None else '',
