...
class Datasource(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AmazonS3Datasource, AzureBlobStorageDatasource, FederatedDatasource, FTPDatasource, GoogleDriveDatasource, HTTPDatasource, SharepointDatasource, UploadedFileDatasource]]:
        ...
        if object_type ==  'amazon_s3':
            return import_module("openapi_client.models.amazon_s3_datasource").AmazonS3Datasource.from_dict(obj)
        if object_type ==  'azure_blob_storage':
            return import_module("openapi_client.models.azure_blob_storage_datasource").AzureBlobStorageDatasource.from_dict(obj)
        if object_type ==  'federated':
            return import_module("openapi_client.models.federated_datasource").FederatedDatasource.from_dict(obj)
        if object_type ==  'ftp':
            return import_module("openapi_client.models.ftp_datasource").FTPDatasource.from_dict(obj)
        if object_type ==  'google_drive':
            return import_module("openapi_client.models.google_drive_datasource").GoogleDriveDatasource.from_dict(obj)
        if object_type ==  'http':
            return import_module("openapi_client.models.http_datasource").HTTPDatasource.from_dict(obj)
        if object_type ==  'sharepoint':
            return import_module("openapi_client.models.sharepoint_datasource").SharepointDatasource.from_dict(obj)
        if object_type ==  'uploaded_file':
            return import_module("openapi_client.models.uploaded_file_datasource").UploadedFileDatasource.from_dict(obj)
