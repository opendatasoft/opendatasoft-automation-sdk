...
class ExploreLimits(BaseModel):
    """
    ExploreLimits
    """ # noqa: E501
    api_calls: Optional[ExploreLimitsApiCalls] = None
    __properties: ClassVar[List[str]] = ["api_calls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "api_calls": ExploreLimitsApiCalls.from_dict(obj["api_calls"]) if obj.get("api_calls") is not None else None
        })
        return _obj
