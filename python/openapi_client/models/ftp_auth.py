...
class FTPAuth(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[FTPBasicAuth]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[FTPBasicAuth]]:
        """Create an instance of FTPAuth from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'basic_auth':
            return import_module("openapi_client.models.ftp_basic_auth").FTPBasicAuth.from_dict(obj)
