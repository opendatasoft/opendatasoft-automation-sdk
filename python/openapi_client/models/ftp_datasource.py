...
class FTPDatasource(Datasource):
    ...
    connection: FTPDatasource1Connection
    __properties: ClassVar[List[str]] = ["type", "relative_url", "connection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connection": FTPDatasource1Connection.from_dict(obj["connection"]) if obj.get("connection") is not None else None
        })
        return _obj
