...
class FTPWithMetaCSVHarvester(Harvester):
    """
    ...
    password: Optional[StrictStr] = Field(description="The password for the user. The API returns null to hide this sensitive value.")
    directory: Optional[StrictStr] = ''
    metadata_file: Annotated[str, Field(min_length=1, strict=True)]
    resource_location_column: Optional[StrictStr] = 'source_dataset'
    resource_schema_column: Optional[StrictStr] = ''
    csv_separator: Optional[StrictStr] = ';'
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata_file": obj.get("metadata_file"),
            "resource_location_column": obj.get("resource_location_column") if obj.get("resource_location_column") is not None else 'source_dataset',
            "resource_schema_column": obj.get("resource_schema_column") if obj.get("resource_schema_column") is not None else '',
            "csv_separator": obj.get("csv_separator") if obj.get("csv_separator") is not None else ';',
