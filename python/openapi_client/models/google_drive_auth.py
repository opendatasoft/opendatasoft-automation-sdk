...
class GoogleDriveAuth(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[GoogleDriveOIDCAuth]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[GoogleDriveOIDCAuth]]:
        """Create an instance of GoogleDriveAuth from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'oidc':
            return import_module("openapi_client.models.google_drive_oidc_auth").GoogleDriveOIDCAuth.from_dict(obj)
