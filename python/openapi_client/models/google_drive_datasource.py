...
class GoogleDriveDatasource(Datasource):
    ...
    """ # noqa: E501
    file_id: StrictStr
    connection: GoogleDriveDatasourceAllOfConnection
    __properties: ClassVar[List[str]] = ["type", "file_id", "connection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connection": GoogleDriveDatasourceAllOfConnection.from_dict(obj["connection"]) if obj.get("connection") is not None else None
        })
        return _obj
