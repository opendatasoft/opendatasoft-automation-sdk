...
class JunarHarvester(Harvester):
    """
    JunarHarvester
    """ # noqa: E501
    url: Annotated[str, Field(min_length=1, strict=True)]
    auth_key: Optional[StrictStr] = Field(description="The Junar auth key. The API returns null to hide this sensitive value.")
    query_string: Optional[StrictStr] = ''
    categories: Optional[StrictStr] = ''
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "query_string": obj.get("query_string") if obj.get("query_string") is not None else '',
