...
class ListDatasetFeedbacks200Response(BaseModel):
    """
    ...
    results: Optional[List[DatasetFeedback]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [DatasetFeedback.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
