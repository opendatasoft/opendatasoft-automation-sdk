...
class OMINodeHarvester(Harvester):
    """
    OMINodeHarvester
    """ # noqa: E501
    url: Annotated[str, Field(min_length=1, strict=True)]
    infoitems_limit: Optional[StrictInt] = None
    omi_node_version: Optional[StrictStr] = '0.9.0'
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if infoitems_limit (nullable) is None
        # and model_fields_set contains the field
        if self.infoitems_limit is None and "infoitems_limit" in self.model_fields_set:
            _dict['infoitems_limit'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "infoitems_limit": obj.get("infoitems_limit"),
            "omi_node_version": obj.get("omi_node_version") if obj.get("omi_node_version") is not None else '0.9.0',
