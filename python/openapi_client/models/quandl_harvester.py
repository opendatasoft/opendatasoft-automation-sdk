...
class QuandlHarvester(Harvester):
    """
    QuandlHarvester
    """ # noqa: E501
    database_code: Annotated[str, Field(min_length=1, strict=True)]
    api_key: Optional[StrictStr] = Field(description="The API key for the Quandl service. The API returns null to hide this sensitive value.")
    number_of_datasets: Annotated[int, Field(strict=True, ge=0)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "database_code": obj.get("database_code"),
