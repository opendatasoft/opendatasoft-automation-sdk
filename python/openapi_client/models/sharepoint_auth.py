...
class SharepointAuth(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[SharepointOIDCAuth]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[SharepointOIDCAuth]]:
        """Create an instance of SharepointAuth from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'oidc':
            return import_module("openapi_client.models.sharepoint_oidc_auth").SharepointOIDCAuth.from_dict(obj)
