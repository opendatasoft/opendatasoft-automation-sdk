...
class UpdateDatasetAlternativeExportRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["title", "type", "description"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['uploaded_file']):
            raise ValueError("must be one of enum values ('uploaded_file')")
        return value
