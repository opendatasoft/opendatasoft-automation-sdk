...
class DatasetSchedulesApi:
    ...
    @validate_call
    def create_dataset_schedule(
        self,
        dataset_uid: StrictStr,
        dataset_schedule: Optional[DatasetSchedule] = None,
        ...
        :type dataset_schedule: DatasetSchedule
        ...
        _param = self._create_dataset_schedule_serialize(
    ...
    @validate_call
    def create_dataset_schedule_with_http_info(
        self,
        dataset_uid: StrictStr,
        dataset_schedule: Optional[DatasetSchedule] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def create_dataset_schedule_without_preload_content(
        self,
        dataset_uid: StrictStr,
        dataset_schedule: Optional[DatasetSchedule] = None,
        _request_timeout: Union[
    ...
    def _create_dataset_schedule_serialize(
        self,
        dataset_uid,
        dataset_schedule,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/datasets/{dataset_uid}/schedules/',
    ...
    def delete_dataset_schedule(
        ...
        _param = self._delete_dataset_schedule_serialize(
            dataset_uid=dataset_uid,
    ...
    @validate_call
    def delete_dataset_schedule_with_http_info(
        self,
        dataset_uid: StrictStr,
        schedule_uid: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_dataset_schedule_without_preload_content(
        self,
        dataset_uid: StrictStr,
        schedule_uid: StrictStr,
        _request_timeout: Union[
    ...
    def _delete_dataset_schedule_serialize(
        self,
        dataset_uid,
        schedule_uid,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/datasets/{dataset_uid}/schedules/{schedule_uid}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_dataset_schedules(
        ...
        _param = self._list_dataset_schedules_serialize(
            dataset_uid=dataset_uid,
            limit=limit,
            offset=offset,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListDatasetSchedules200Response",
            '404': "InlineObject2",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def list_dataset_schedules_with_http_info(
        self,
        dataset_uid: StrictStr,
        limit: Annotated[Optional[Union[Annotated[float, Field(le=1000, strict=True, ge=0)], Annotated[int, Field(le=1000, strict=True, ge=0)]]], Field(description="The maximum number of results returned by the API when the response is paginated. Tip: You can make a request with the parameter \"limit\" set to 0 to get only the metadata (\"results\" property will contain an empty array).")] = None,
        offset: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to skip before beginning the listing in case of a paginated response")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListDatasetSchedules200Response]:
        """List dataset schedules
    ...
    @validate_call
    def list_dataset_schedules_without_preload_content(
        self,
        dataset_uid: StrictStr,
        limit: Annotated[Optional[Union[Annotated[float, Field(le=1000, strict=True, ge=0)], Annotated[int, Field(le=1000, strict=True, ge=0)]]], Field(description="The maximum number of results returned by the API when the response is paginated. Tip: You can make a request with the parameter \"limit\" set to 0 to get only the metadata (\"results\" property will contain an empty array).")] = None,
        offset: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The number of results to skip before beginning the listing in case of a paginated response")] = None,
    ...
    def _list_dataset_schedules_serialize(
        self,
        dataset_uid,
        limit,
        offset,
    ...
    def retrieve_dataset_schedule(
        ...
        _param = self._retrieve_dataset_schedule_serialize(
            dataset_uid=dataset_uid,
            schedule_uid=schedule_uid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def retrieve_dataset_schedule_with_http_info(
        self,
        dataset_uid: StrictStr,
        schedule_uid: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def retrieve_dataset_schedule_without_preload_content(
        self,
        dataset_uid: StrictStr,
        schedule_uid: StrictStr,
        _request_timeout: Union[
    ...
    def _retrieve_dataset_schedule_serialize(
        self,
        dataset_uid,
        schedule_uid,
        _request_auth,
    ...
    def update_dataset_schedule(
        ...
        _param = self._update_dataset_schedule_serialize(
            dataset_uid=dataset_uid,
            schedule_uid=schedule_uid,
            dataset_schedule=dataset_schedule,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_dataset_schedule_with_http_info(
        self,
        dataset_uid: StrictStr,
        schedule_uid: StrictStr,
        dataset_schedule: Optional[DatasetSchedule] = None,
    ...
    @validate_call
    def update_dataset_schedule_without_preload_content(
        self,
        dataset_uid: StrictStr,
        schedule_uid: StrictStr,
        dataset_schedule: Optional[DatasetSchedule] = None,
    ...
    def _update_dataset_schedule_serialize(
        self,
        dataset_uid,
        schedule_uid,
        dataset_schedule,
