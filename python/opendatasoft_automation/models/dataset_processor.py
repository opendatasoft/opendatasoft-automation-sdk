...
class DatasetProcessor(BaseModel):
    ...
    """ # noqa: E501
    uid: Optional[StrictStr] = Field(default=None, description="Unique identifier for the processor")
    type: StrictStr = Field(description="Type of the processor")
    label: StrictStr = Field(description="Friendly label of the processor")
