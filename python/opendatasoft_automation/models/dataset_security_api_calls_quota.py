...
class DatasetSecurityApiCallsQuota(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["unit", "limit"]
    ...
    def unit_validate_enum(cls, value):
        ...
        if value not in set(['second', 'minute', 'hour', 'day', 'month']):
            raise ValueError("must be one of enum values ('second', 'minute', 'hour', 'day', 'month')")
        return value
