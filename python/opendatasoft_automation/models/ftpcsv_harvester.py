...
class FTPCSVHarvester(Harvester):
    """
    FTPCSVHarvester
    """ # noqa: E501
    host: Annotated[str, Field(min_length=1, strict=True)]
    user: Annotated[str, Field(min_length=1, strict=True)]
    password: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="The password for the user. The API returns null to hide this sensitive value.")
    directory: Optional[StrictStr] = ''
    metadata_file: StrictStr
    metadata_join_key: Optional[StrictStr] = 'source_dataset'
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata_join_key": obj.get("metadata_join_key") if obj.get("metadata_join_key") is not None else 'source_dataset',
