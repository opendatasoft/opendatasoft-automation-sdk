...
class HTTPDatasource(Datasource):
    ...
    HTTPDatasource
    """ # noqa: E501
    relative_url: Optional[StrictStr] = None
    headers: Optional[List[HTTPDatasource1Headers]] = None
    connection: HTTPDatasource1Connection
    __properties: ClassVar[List[str]] = ["type", "relative_url", "headers", "connection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connection": HTTPDatasource1Connection.from_dict(obj["connection"]) if obj.get("connection") is not None else None
        })
        return _obj
