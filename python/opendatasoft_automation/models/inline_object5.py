...
class InlineObject5(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records_errors": [InlineObject5RecordsErrorsInner.from_dict(_item) for _item in obj["records_errors"]] if obj.get("records_errors") is not None else None,
