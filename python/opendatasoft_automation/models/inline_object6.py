...
class InlineObject6(BaseModel):
    ...
    InlineObject6
    """ # noqa: E501
    fields: Optional[List[InlineObject6FieldsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [InlineObject6FieldsInner.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
