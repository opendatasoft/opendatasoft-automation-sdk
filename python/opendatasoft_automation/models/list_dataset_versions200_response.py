...
class ListDatasetVersions200Response(BaseModel):
    """
    ...
    results: Optional[List[DatasetVersion]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [DatasetVersion.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
