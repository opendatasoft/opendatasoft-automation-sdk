...
class ListImages200Response(BaseModel):
    """
    ...
    results: Optional[List[ListImages200ResponseAllOfResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [ListImages200ResponseAllOfResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
