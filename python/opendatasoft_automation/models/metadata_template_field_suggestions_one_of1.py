...
class MetadataTemplateFieldSuggestionsOneOf1(BaseModel):
    """
    ...
    exhaustive: Optional[MetadataTemplateFieldSuggestionsOneOf1Exhaustive] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exhaustive": MetadataTemplateFieldSuggestionsOneOf1Exhaustive.from_dict(obj["exhaustive"]) if obj.get("exhaustive") is not None else None,
            "query": obj.get("query"),
