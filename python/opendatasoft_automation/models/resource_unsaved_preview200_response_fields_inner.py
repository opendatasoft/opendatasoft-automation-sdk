...
class ResourceUnsavedPreview200ResponseFieldsInner(BaseModel):
    """
    ...
    annotations: Optional[List[ResourceUnsavedPreview200ResponseFieldsInnerAnnotationsInner]] = None
    name: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "label": obj.get("label"),
            "type": obj.get("type"),
            "annotations": [ResourceUnsavedPreview200ResponseFieldsInnerAnnotationsInner.from_dict(_item) for _item in obj["annotations"]] if obj.get("annotations") is not None else None,
            "name": obj.get("name")
        })
        return _obj
