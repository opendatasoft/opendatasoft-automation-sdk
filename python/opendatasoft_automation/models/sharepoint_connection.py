...
class SharepointConnection(Connection):
    ...
    """ # noqa: E501
    auth: Optional[SharepointAuth] = None
    __properties: ClassVar[List[str]] = ["uid", "type", "is_reusable", "can_reuse", "can_manage", "dataset_count", "user_count", "group_count", "created_at", "updated_at", "auth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auth": SharepointAuth.from_dict(obj["auth"]) if obj.get("auth") is not None else None
        })
        return _obj
