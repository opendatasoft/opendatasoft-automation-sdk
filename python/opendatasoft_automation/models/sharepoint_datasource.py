...
class SharepointDatasource(Datasource):
    ...
    file_id: StrictStr
    drive_id: StrictStr
    connection: SharepointDatasource1Connection
    __properties: ClassVar[List[str]] = ["type", "file_id", "drive_id", "connection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connection": SharepointDatasource1Connection.from_dict(obj["connection"]) if obj.get("connection") is not None else None
        })
        return _obj
