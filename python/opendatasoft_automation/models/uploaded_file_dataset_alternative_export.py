...
class UploadedFileDatasetAlternativeExport(DatasetAlternativeExport):
    """
    UploadedFileDatasetAlternativeExport
    """ # noqa: E501
    filename: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["uid", "title", "description", "mimetype", "type", "created_at", "updated_at", "filename"]
