...
class URLDatasetAlternativeExport(DatasetAlternativeExport):
    """
    URLDatasetAlternativeExport
    """ # noqa: E501
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["uid", "title", "description", "mimetype", "type", "created_at", "updated_at", "url"]
