...
class TestInviteUsers200ResponseValue(unittest.TestCase):
    """InviteUsers200ResponseValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteUsers200ResponseValue:
        """Test InviteUsers200ResponseValue
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InviteUsers200ResponseValue`
        """
        model = InviteUsers200ResponseValue()
        if include_optional:
            return InviteUsers200ResponseValue(
                status_code = 'success',
                data = opendatasoft_automation.models.user_schema.User schema(
    ...
    def testInviteUsers200ResponseValue(self):
        """Test InviteUsers200ResponseValue"""
