    ...
    def make_instance(self, include_optional) -> ListDatasets200Response:
        ...
        if include_optional:
            return ListDatasets200Response(
                ...
                previous = '',
                results = [
                    opendatasoft_automation.models.dataset_schema.Dataset schema(
                        uid = 'da_qf2hyt', 
                        ...
                        is_published = True, 
                        is_restricted = True, 
                        metadata = opendatasoft_automation.models.dataset_metadata_schema.Dataset metadata schema(
                        ...
                        default_security = opendatasoft_automation.models.dataset_security.DatasetSecurity(
